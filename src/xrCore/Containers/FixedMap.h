...
template <class K, class T, class allocator = XRay::xray_allocator<xr_fixed_map_node<K, T>>>
class xr_fixed_map
{
...
private:
    ...
    void get_left_right(value_type* N, xr_vector<T, XRay::xray_allocator<T>>& D)
    {
        if (N->left)
    ...
    void get_right_left(value_type* N, xr_vector<T, XRay::xray_allocator<T>>& D)
    {
        if (N->right)
    ...
    void get_left_right_p(value_type* N, xr_vector<value_type*, XRay::xray_allocator<value_type*>>& D)
    {
        if (N->left)
    ...
    void get_right_left_p(value_type* N, xr_vector<value_type*, XRay::xray_allocator<value_type*>>& D)
    {
        if (N->right)
...
public:
    ...
    void get_left_right(xr_vector<T, XRay::xray_allocator<T>>& D)
    {
        if (pool)
            get_left_right(nodes, D);
    }

    void get_left_right_p(xr_vector<value_type*, XRay::xray_allocator<value_type*>>& D)
    {
        if (pool)
            get_left_right_p(nodes, D);
    }

    void get_right_left(xr_vector<T, XRay::xray_allocator<T>>& D)
    {
        if (pool)
            get_right_left(nodes, D);
    }

    void get_right_left_p(xr_vector<value_type*, XRay::xray_allocator<value_type*>>& D)
    {
        if (pool)
            get_right_left_p(nodes, D);
    }

    void get_any_p(xr_vector<value_type*, XRay::xray_allocator<value_type*>>& D)
    {
        D.resize(size());
